...
If you do not have OpenCV installed, I highly recommend that you attempt to do so using a 
virtual box, making sure to also install the face module, which is part of the OpenCV-contrib
project.
...
def test_individual(image_to_test, threshold=40, recognizer=cv2.face.createLBPHFaceRecognizer, recog_model='recog_brain.yml'):
	...
	Make sure there is a recog_model file that has been generated by the train_recognizer function. Returns a boolean."""
	recognizer = recognizer()
	recognizer.load(recog_model)
