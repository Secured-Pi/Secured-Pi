...
def test_individual(image_to_test, threshold=40, recog_model=RECOG_MODEL, verbose=False):
    ...
    image_array = np.array(Image.open(os.path.join(BASE_DIR, image_to_test)).convert('L'), 'uint8')
